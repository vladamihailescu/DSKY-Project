...
portS=serial.Serial(port='/dev/ttyAMA0',baudrate=9600, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS, timeout=1)
eof = b'\xff\xff\xff'
turnOFF = b'33808'
turnON = b'24544'
time.sleep(2)
...
#portS.write(b'page1' + eof)
portS.write(b'cal.bco=' + turnOFF + eof)
#portS.write(b'pl.bco=' + turnOFF + eof)
#portS.write(b'vl.bco=' + turnOFF + eof)
#portS.write(b'nl.bco=' + turnOFF + eof)
portS.write(b'p0.txt=""' + eof)
portS.write(b'p1.txt=""' + eof)
portS.write(b'v0.txt=""' + eof)
portS.write(b'v1.txt=""' + eof)
portS.write(b'n0.txt=""' + eof)
portS.write(b'n1.txt=""' + eof)
portS.write(b'l1.pco=23243' + eof)
portS.write(b'l2.pco=' + turnOFF + eof)
portS.write(b'l3.pco=' + turnOFF + eof)
portS.write(b'r10.txt=""' + eof)
portS.write(b'r11.txt=""' + eof)
portS.write(b'r12.txt=""' + eof)
portS.write(b'r13.txt=""' + eof)
portS.write(b'r14.txt=""' + eof)
portS.write(b'r15.txt=""' + eof)
portS.write(b'r20.txt=""' + eof)
portS.write(b'r21.txt=""' + eof)
portS.write(b'r22.txt=""' + eof)
portS.write(b'r23.txt=""' + eof)
portS.write(b'r24.txt=""' + eof)
portS.write(b'r25.txt=""' + eof)
portS.write(b'r30.txt=""' + eof)
portS.write(b'r31.txt=""' + eof)
portS.write(b'r32.txt=""' + eof)
portS.write(b'r33.txt=""' + eof)
portS.write(b'r34.txt=""' + eof)
portS.write(b'r35.txt=""' + eof)
...
def displayGraphic(x, y, img):
	...
	if img == imageCompActyOn: portS.write(b'cal.bco=' + turnON + eof)
	elif img == imageCompActyOff: portS.write(b'cal.bco=' + turnOFF + eof)
	elif img == imageSeparatorOn: portS.write((hmiObj + '.pco=' + hmiValue + '\xff\xff\xff').encode('latin_1'))
	elif img == imageSeparatorOff: portS.write((hmiObj + '.pco=33808\xff\xff\xff').encode('latin_1'))
	elif x == 0 and y == 212 and img == imageSeparatorOff: portS.write(('l1.pco=23243\xff\xff\xff').encode('latin_1'))
	else: portS.write((hmiObj + '.txt=' + hmiValue + '\xff\xff\xff').encode('latin_1'))
...
def vnFlashingHandler():
	...
	if vnFlashing:
		...
		if vnCurrentlyOn:
			...
			portS.write(b'v0.pco=' + turnON + eof)
			portS.write(b'v1.pco=' + turnON + eof)
			portS.write(b'n0.pco=' + turnON + eof)
			portS.write(b'n1.pco=' + turnON + eof)
		else:
			...
			portS.write(b'v0.pco=' + turnOFF + eof)
			portS.write(b'v1.pco=' + turnOFF + eof)
			portS.write(b'n0.pco=' + turnOFF + eof)
			portS.write(b'n1.pco=' + turnOFF + eof)
	...
	if args.pigpio:
		...
		for i in range(0,8):
			if ledArray[i] != lastLedArray[i]:
				...
				#Vlad Mihailescu - edit
				writeI2c((i + 1) + ledArray[i])
...
def outputFromAGC(channel, value):
	...
	if channel == 0o10:
		...
		if (value & 0x02) != 0:
			...
			#portS.write(b'cal.bco=' + turnON + eof)
		else:
			displayGraphic(0, 0, imageCompActyOff)
			#portS.write(b'cal.bco=' + turnOFF + eof)
