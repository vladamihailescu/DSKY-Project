...
ser_disp=serial.Serial('/dev/ttySC1', baudrate=9600, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS, timeout=1)
ser_alarm=serial.Serial('/dev/ttySC0', baudrate=115200, timeout=1)
